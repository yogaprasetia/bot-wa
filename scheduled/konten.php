		...
		<label for="refresh"><small>Auto Refresh </small></label>
					...
					<div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                         <b><h3 class="panel-title"><i class="fa fa-bell-o"></i>SCHEDULED MESSAGE&nbsp;&nbsp;&nbsp;<span class="pull-right badge badge-dark" style="background-color: #777;"><? echo number_format($scheduled) ; ?></span></h3></b>
                                    </div>
									<div class="pull-right">
									<a href = "../send2"><button class="btn btn-large btn-primary btn-round"><i class="fa fa-bell-o"></i>  Send Reminder/ Scheduled Message</button></a>
									<button class="btn btn-danger" onclick="reset()" ><i class="fa fa-bolt"></i>  RESET SCHEDULE </button>
