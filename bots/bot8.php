...
case 'HI':
	...
	*1* - 24K [BAR] Gold Rate
	*2* - 23.5K [VEDHANI] Gold Rate
	*3* - 22K [JEWELLERY] Gold Rate
	*4* - 18K [JEWELLERY] Gold Rate
	*5* - Silver Rate
	
	Please select an option to move ahead.
	Example: Reply *1* to get 24K Gold Rate.
	";
	/*6 Order Status
	7 Cotact Us
	8 Other Queries
...
case '1':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhicbc/G/24");  
...
case '2':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhicbc/G/23.5");  
...
case '3':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhicbc/G/22");  
...
case '4':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhicbc/G/18");  
...
case '5':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhicbc/S/0");  
