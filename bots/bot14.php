...
case '1':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhilaxi/G/22");  
...
case '2':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhilaxi/G/23");  
  $msg =  ' 23K Gold Rate Per Gram Rs.'. substr($json,10,7);

  sendMessage($wa_profil, $wa_no, $msg );
  break;
  
case '3':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhilaxi/G/24");  
...
case '4':
  $json = file_get_contents("https://siddhi.parasinfotech.co.in/siddhi50_api/api/master/rate/siddhilaxi/S/0");  
