...
case 'INFO':
$msg = "*Halo.. Selamat Datang di BOT RSUD dr Darsono Pacitan:*

Masukkan Data Anda Dengan Format :
*NAMA#NOMOR NIP#NOMOR REKENING*";
sendMessage($wa_profil, $wa_no, $msg);
break;

case '1':
$msg = "Masukkan Data Anda Dengan Format :
