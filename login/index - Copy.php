										...
										<div class="widget-main">
											...
											<form id="formLogin" action="">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="userpass" name="userpass" class="form-control" placeholder="Password" value="">
										...
										<div class="widget-main">
											...
											<form id="formLupa">
												<fieldset>
													...
													<div class="clearfix">
														<button type="button" id="btnlupa" class="width-35 pull-right btn btn-sm btn-danger">
