						...
						<div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><i class="fa fa-bullhorn"></i>  BROADCAST / BULK MESSAGE</h3>										 
                                    </div>
									 <div class="pull-right">
									 <a href="../wg_files/blast.xls" class="btn btn-success pull-right "><i class="fa fa-file-excel-o"></i> Download XLS Template  </a>
									 </div>
...
<?
$hasil = mysqli_query($koneksi, "select * from multi where profil = '$profil' and tipe = 'D' order by id"  ) ;
$no = 0 ;
