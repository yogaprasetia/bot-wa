		...
		<label for="refresh"><small>Auto Refresh </small></label>
					...
					<div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                         <b><h3 class="panel-title"><i class="fa fa-comments"></i>SMS OUTBOX&nbsp;&nbsp;&nbsp;<span class="pull-right badge badge-dark" style="background-color: #777;"><? echo number_format($sms) ; ?></span></h3></b>
                                    </div>
									<div class="pull-right">
									<a href = "../sms"><button class="btn btn-large btn-primary btn-round"><i class="fa fa-comments"></i>  Send SMS</button></a>
									<button class="btn btn-danger" onclick="reset()" ><i class="fa fa-bolt"></i>  RESET SMS OUT </button>
...
if ($multi != 'yes') {
$hasil = mysqli_query($koneksi, "select * from outbox where wa_mode = '3'   order by id"  ) ;}
else{
$hasil = mysqli_query($koneksi, "select * from multi where  profil = '$profil' and tipe = 'O'  and wa_mode = '3'  and  concat(wa_no,wa_text) like '%$cari%' order by id"  ) ;}
