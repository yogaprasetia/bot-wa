...
if ($tipe=='') {
	...
	if ($multi != 'yes') {	
		...
		mysqli_query($koneksi,"INSERT into multi (tipe, profil, wa_mode, wa_no, wa_text, wa_media, wa_file) values('O', '$profil', '0','$wa_no','$wa_text','$wa_media', '$wa_file')");
	} 
	header("Location:index2.php?ok=yes"); 
}	
 else
{
	if ($tipe =='image') {
