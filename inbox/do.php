...
$html = $tabel . "
    <thead>  
		...
		<th align='center'><center>Reply</center></th>		
...
<a href='../send/index2.php?id=$id' target='popup' onclick='openWin()' style='text-decoration: none;color:#333;'><button><i class='fa fa-send'></i></button></a> 
</td><td  width=20></td>				
      </tr>
";		  
...
if ($format=='xls') {
	$nama_file = "Inbox". '_' . $awal . '_' . $akhir . ".xls";   
