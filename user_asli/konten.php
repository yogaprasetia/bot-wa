...
<table class='table table-hover table-condensed table-striped table-bordered'>
    <thead>  
		...
		<th align='center'><center>Create Dt</center></th>	
		<th align='center'><center>Last Login</center></th>	
		<th align='center'><center>Expire Dt</center></th>	
		...
		<th align='center'><center>Set FULL</center></th>		
		<th align='center'><center>Set TRIAL</center></th>		
...
<!--	<td> <? echo $password ; ?> </td> 
	...
	<td width=150 align='center'  > <? echo $create_dt ; ?> </td>   	
	<td width=150 align='center'  > <? echo $last_login ; ?> </td>
	<td align='center'> Lom dibikin </td>
	...
	<td width=30 align='center'  <? if ($status == 'Y') {echo " style='background-color:rgb(0,255,255);' " ;} ?>  > <? echo $status ; ?> </td>   
	<td width=10 align='center'  >  
	<a href="y.php?id=<? echo $id ?>" data-toggle="tooltip" data-placement="top"  title="" data-original-title=""><button>Y</button> </a>
	</td>	
	<td width=10 align='center'  >  
	<a href="n.php?id=<? echo $id ?>" data-toggle="tooltip" data-placement="top"  title="" data-original-title=""><button>N</i></button> </a>
	</td>	
	...
	?>
	<a href="off.php?id=<? echo $id ?>&id00=<? echo $id00 ?>" data-toggle="tooltip" data-placement="top" onclick="return confirm('Are you sure you want to DISCONNECT this?')" title="" data-original-title="Disconnect"><button><i class='fa fa-cut'></i></button> </a>
	<? } ?>
	</td>	
	
	<td width=10 align='center'  >  
	<? if ($con=='-') { ?>
	<a href="del.php?id=<? echo $id ?>" data-toggle="tooltip" data-placement="top" onclick="return confirm('Are you sure you want to DELETE this?')" title="" data-original-title="Delete"><button><i class='fa fa-trash-o'></i></button> </a>
	<? } ?>
	</td>		
