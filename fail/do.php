...
$html = $tabel . "
    <thead>  
		...
		<th align='center'><center>SMS</center></th>		
    </thead>
    <tbody>
";
} else {
...
<td  width=20 class='text-center'>                                                
<a href='../send/index4.php?id=$id' target='popup' onclick='openWin()' style='text-decoration: none;color:#333;'><button><i class='fa fa-comments'></i></button></a> 
</td> 		
      </tr>
";		  
} else {
...
if ($format=='xls') {
	$nama_file = "Fail". '_' . $awal . '_' . $akhir . ".xls";   
